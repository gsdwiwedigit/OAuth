      ...
      <div className="w-full max-w-md relative animate-fadeIn">
        <div className="glass-effect rounded-3xl p-8 md:p-10 shadow-2xl">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl mb-6 shadow-lg shadow-indigo-500/30 transform hover:scale-110 transition-transform duration-300">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400 bg-clip-text text-transparent mb-3 font-[family-name:var(--font-sora)]">
              Email Notification
            </h1>
          ...
          <div className="space-y-3 mb-8">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 hover:border-slate-600 rounded-xl transition-all duration-200 group"
            >
              <svg className="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
              </svg>
              <span className="text-slate-200 font-medium">Continue with Facebook</span>
            </button>
            ...
            >
              ...
              <span className="text-slate-200 font-medium">Continue with Instagram</span>
            </button>
            ...
            >
              ...
              <span className="text-slate-200 font-medium">Continue with LinkedIn</span>
            </button>
            ...
            >
              ...
              <span className="text-slate-200 font-medium">Continue with Reddit</span>
            </button>
          </div>
